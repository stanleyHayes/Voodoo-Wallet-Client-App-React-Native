    ...
    return function (dispatch) {
        ...
        axios({
            ...
            Swal.fire({
                icon: "success",
                title: "success",
                text: `Account creation successful\nAccount verification details sent to your email`,
            });
...
export const resetPassword = function (password, resetToken) {
    return function (dispatch) {
        ...
        axios({
            method: 'put',
            url: `http://localhost:8000/api/v1/auth/reset-password/${resetToken}`,
            data: {password}
        }).then(function (response) {
...
export const verifyAccount = function (verifyToken) {
    return function (dispatch) {
        ...
        axios({
            method: 'put',
            url: `http://localhost:8000/api/v1/auth/verify/${verifyToken}`,
        }).then(function (response) {
